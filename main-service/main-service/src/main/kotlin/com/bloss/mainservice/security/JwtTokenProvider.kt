...
import com.bloss.mainservice.exception.JwtAuthenticationException
import com.bloss.mainservice.exception.JwtResolvationException
...
@Component
class JwtTokenProvider(private val appProperties: com.bloss.mainservice.config.AppProperties) {
